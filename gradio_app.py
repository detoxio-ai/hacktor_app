...
with gr.Blocks(theme=gr.themes.Ocean()) as demo:
    ...
    with gr.Tab("How it Works?"):
        ...
        **Step 2:** Copy the generated prompt and try it on an LLM of your choice.

        **Step 3:** Copy the response generated by the LLM, go to the **Evaluate Text** tab.

        **Step 4:** Paste the LLM's response into the input box and hit **Evaluate Text**.

        **Step 5:** Review whether the response is classified as **SAFE** or **UNSAFE**.
